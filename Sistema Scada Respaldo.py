...
if isinstance(df_incidencias, pd.DataFrame) and not df_incidencias.empty:
    ...
    # 1. Incidencias Activas con línea azul superior
    tz_mx = pytz.timezone('America/Mexico_City')
    st.markdown('<hr style="border: none; height: 1px; background-color: #2e4053; margin-top: 20px; margin-bottom: 20px;">', unsafe_allow_html=True)
